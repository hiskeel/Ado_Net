...
INSERT INTO Salles(ProductId, Price, Quantity, EmployeeId, ClientId, SaleDate)
VALUES  (1, 10000, 1, 1, 1, '2024-03-07'),
		(1, 100, 1, 1, 1,'2024-02-07'),
		(4, 1800, 1, 2, 2,'2024-04-01'),
		(2, 10000, 3, 4, 2,'2024-01-07');
INSERT INTO Salles(ProductId, Price, Quantity, EmployeeId, ClientId, SaleDate)
VALUES  (1, 1000, 1, 1, 1, '2024-03-06');
GO
...
select TOP 1 s.Id,s.ProductId, s.Price ,s.EmployeeId, s.ClientId,s.Quantity from Salles s 
